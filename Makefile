...
all: rds-cli-completion-generator ## Build all binaries

rds-cli-completion-generator:
	@echo "[36;1mBuilding rds-cli-completion-generator…[0m"
	@go build $(VERBOSE_FLAG) -ldflags="-X main.gitrev=$(GITREV)" rds-cli-completion-generator.go

install: ## Install all binaries
	@echo "[36;1mInstalling binaries…[0m"
	@cp rds-cli-completion-generator /usr/bin/rds-cli-completion-generator

uninstall: ## Uninstall all binaries
	@echo "[36;1mRemoving installed binaries…[0m"
	@rm -f /usr/bin/rds-cli-completion-generator
...
clean: ## Remove generated files
	...
	@rm -f rds-cli-completion-generator
